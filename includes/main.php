  ...
  <header class="page-header">
    ...
    <div class="page-header__topline">
      <div class="container clearfix">
        ...
        <div class="currency">
          <a class="currency__change" href="customer/my_account.php">
          <?php
    ...
    <div class="page-header__bottomline">
      <div class="container clearfix">
        ...
        <div class="logo">
          ...
          <img class="logo__img" src="images/logo.png" alt="SrmKart logotype" width="273" height="57">
          </a>
        </div>
        ...
        <nav class="main-nav">
          ...
          <li class="categories__item">
              <a class="categories__link" href="customer/my_account.php">
                My Account
